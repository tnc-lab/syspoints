...
const DEFAULT_TRANSLATIONS = {
  es: {
    ...
    "review.step2.addressEditableLabel": "Direccion del establecimiento (editable):",
    "review.step2.addressPlaceholder": "Ingresa la direccion del establecimiento",
    "review.step2.addressHint": "La direccion se guardara al confirmar el establecimiento.",
    ...
    "review.step2.mapMoveMode": "Mover mapa",
    "review.step2.mapPickMode": "Marcar ubicacion",
    "review.step2.mapMoveHint": "Modo mover: arrastra el mapa con la mano antes de elegir.",
    "review.step2.mapPickHint": "Haz click en el mapa para marcar la ubicacion exacta del establecimiento.",
    "review.step2.mapPicking": "Marcando punto en el mapa...",
    "review.step3.title": "Paso 3: Titulo, descripcion y tags",
    ...
    "review.step5.title": "Paso 5: Valoracion, precio y URL de compra",
    ...
    "review.step9.uploadMode": "Subir imagen",
    "review.step9.pasteMode": "Pegar imagen",
    "review.step9.uploadBoxHint": "Sube una imagen desde tu dispositivo.",
    "review.step9.pasteBoxHint": "Pega una imagen desde el portapapeles (Ctrl/Cmd + V).",
    "review.step9.pastePlaceholder": "Haz click aqui y pega la imagen...",
    "review.step9.pasteNoImage": "No se detecto una imagen en el portapapeles.",
    ...
    "review.location.pickFromMapFailed": "No se pudo marcar este punto en el mapa.",
  ...
  en: {
    ...
    "review.step2.addressEditableLabel": "Establishment address (editable):",
    "review.step2.addressPlaceholder": "Enter establishment address",
    "review.step2.addressHint": "The address will be saved when confirming the establishment.",
    ...
    "review.step2.mapMoveMode": "Move map",
    "review.step2.mapPickMode": "Mark location",
    "review.step2.mapMoveHint": "Move mode: drag the map with the hand before choosing.",
    "review.step2.mapPickHint": "Click the map to mark the exact establishment location.",
    "review.step2.mapPicking": "Marking point on map...",
    "review.step3.title": "Step 3: Title, description and tags",
    ...
    "review.step5.title": "Step 5: Rating, price and purchase URL",
    ...
    "review.step9.uploadMode": "Upload image",
    "review.step9.pasteMode": "Paste image",
    "review.step9.uploadBoxHint": "Upload an image from your device.",
    "review.step9.pasteBoxHint": "Paste an image from clipboard (Ctrl/Cmd + V).",
    "review.step9.pastePlaceholder": "Click here and paste the image...",
    "review.step9.pasteNoImage": "No image was detected in the clipboard.",
    ...
    "review.location.pickFromMapFailed": "Could not mark this point on the map.",
